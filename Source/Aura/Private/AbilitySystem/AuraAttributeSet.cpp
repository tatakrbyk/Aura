...
void UAuraAttributeSet::Debuff(const FEffectProperties& Props)
{
	...
	// ADD Tag AURA
	Effect->InheritableOwnedTagsContainer.AddTag(GameplayTags.DamageTypesToDebuffs[DamageType]); // Not supported 5.4 5.5 version
