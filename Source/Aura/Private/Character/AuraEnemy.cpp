...
AAuraEnemy::AAuraEnemy()
{
	...
	AbilitySystemComponent->SetReplicationMode(EGameplayEffectReplicationMode::Minimal); //Gameplay Effect are NOT replicated. Gameplay Cue ve Gameplay Tags replicated.
